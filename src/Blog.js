...
const Blog = () => {
  ...
  const fetchList = async () => {
    ...
    const response = await nutrionApi
      .get(URL + nutrionURL)
      .then((resp) => {
  ...
  return (
    ...
    <div className="CalorieBody">
      <div className="CalorieTitle">
        Kalorisini öğrenmek istediğiniz yemeği,besini,atıştırmalğı ingilizce aratabilirsiniz.
        <br></br>
        <i>(Örnek: Cheddar Crispy Bread Tomato Soup ,Large chicken barbecue pizza,10oz 
          onion and a tomato,Doritos,oreo vb..)</i>
      </div>
